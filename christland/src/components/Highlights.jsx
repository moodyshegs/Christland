    ...
    <div id="highlights">
      <div className="highlights-inner">
        ...
        <div className="gallery-actions reveal" ref={actionsRef}>
          <button className="btn-outline" onClick={() => alert('Loading more images...')}>Load More Images</button>
          <button className="btn-primary" onClick={() => alert('Opening lightbox...')}>View All in Lightbox</button>
        </div>
      </div>
    </div>
  );
