    ...
    <section id="services">
      <div className="reveal" ref={headingRef}>
        ...
        <h2 className="section-title">
          Experience the <em>Presence of God</em>
          <br />
      ...
      <div className="services-grid">
        <div className="service-card reveal" ref={card1Ref}>
          ...
          <p className="service-detail">
            Join us every Sunday for a powerful time of worship, the Word, and
        ...
        <div className="service-card reveal" ref={card2Ref}>
          ...
          <p className="service-detail">
            Behind Eucharistic College, off Asa-Dam Road, Ilorin, Kwara State,
            Nigeria.
          </p>
          <a
            href="#visit"
